...
Button(root,text="=",command=lambda:calculate()).grid(row=4,column=5)
Button(root,text="+",command=lambda:operation("+")).grid(row=5,column=2)
...
Button(root,text="pi",command=lambda:operation("*3.14")).grid(row=5,column=3)
...
Button(root,text="^2",command=lambda:operation("**2")).grid(row=3,column=5)
